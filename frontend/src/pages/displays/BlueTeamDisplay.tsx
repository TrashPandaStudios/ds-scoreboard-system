...
export const BlueTeamDisplay: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <main className="flex-1 flex flex-col justify-between p-6 lg:p-10 max-w-[1920px] w-full mx-auto relative overflow-hidden bg-gradient-to-b from-blue-950/30 via-[#080b11] to-blue-950/40">
        {/* Fullscreen Button */}
        <button
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 border-b border-blue-500/30 pb-4">
          ...
          <div className="flex items-center gap-4 bg-slate-900/90 px-6 py-2.5 rounded-2xl border border-blue-500/30 shadow-xl">
        ...
        <div className="my-auto flex flex-col items-center justify-center text-center">
          <div className="flex items-center gap-2 text-sm font-mono text-blue-400 bg-blue-950/60 px-4 py-1 rounded-full border border-blue-500/40 mb-4">
            <Target className="w-4 h-4 text-blue-400 animate-pulse" />
            <span>DESIGNATED STRIKER TAG #1</span>
          </div>

          <div className="font-display font-black text-[140px] sm:text-[180px] lg:text-[220px] leading-none text-blue-400 glow-blue select-none tabular-nums">
            {state.blueScore}
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 items-center justify-between gap-6 border-t border-blue-500/30 pt-6">
          {/* Fouls */}
          <div className="flex items-center gap-3">
          ...
          <div className="flex items-center justify-center gap-3 bg-slate-900/80 px-6 py-3 rounded-2xl border border-slate-800">
            ...
            <div className="text-left">
              ...
              <span className="text-2xl font-mono font-black text-white">
                {state.blueSetScore} <span className="text-sm font-normal text-slate-500">/ 2 to win</span>
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-end gap-3 text-right">
            <div>
              ...
              <span className="text-2xl font-display font-black text-red-500 tabular-nums">
                {state.redScore} pts <span className="text-xs text-slate-500">({state.redPenalties} fouls)</span>
              </span>
            </div>
